...
class Gracz:
    ...
    def R1920_1080(self):
        ...
        if self.nazwa_pliku("assest/CmdRunIco/Ico1.cmd") == "" or self.nazwa_pliku("assest/CmdRunIco/Ico1.cmd") == "\"":
        ...
        if self.nazwa_pliku("assest/CmdRunIco/Ico2.cmd") == "" or self.nazwa_pliku("assest/CmdRunIco/Ico2.cmd") == "\"":
        ...
        if self.nazwa_pliku("assest/CmdRunIco/Ico3.cmd") == "" or self.nazwa_pliku("assest/CmdRunIco/Ico3.cmd") == "\"":
        ...
        if self.nazwa_pliku("assest/CmdRunIco/Ico4.cmd") == "" or self.nazwa_pliku("assest/CmdRunIco/Ico4.cmd") == "\"":
        ...
        if self.nazwa_pliku("assest/CmdRunIco/Ico5.cmd") == "" or self.nazwa_pliku("assest/CmdRunIco/Ico5.cmd") == "\"":
    ...
    def nazwa_pliku(self, file_txt):
        path = self.game.save.read(file_txt, 2)
        split = path.split('/')
        return split[-1][:-1]


    def ruchstrzalki(self, pozycja_strzalki, dzielnik_wys):
        if self.game.strzalka_y == pozycja_strzalki:
